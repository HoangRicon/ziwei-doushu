...
const STAR_DETAIL: Record<string, {
  ...
  '紫微': {
    niHaixia: 'Thầy Ni cho rằng Tử Vi là sao hoàng đế, ngồi mệnh cung thì có khí cô độc ngạo, thích ở một mình, không thích bị người khác quản lý. Tử Vi cần Tả Phụ Hữu Bật hỗ trợ hai bên mới phát huy được khí chất đế vương, nếu không chỉ là quân cô độc, giàu mà không quý. Tử Vi ở Thìn Tuất là tốt nhất, cùng Thiên Phủ tạo thành cục diện song tinh, tài quan song mỹ, có thể xuất tướng nhập tướng. Tử Vi sợ nhất là Hỏa Tinh, Linh Tinh, Kình Dương, Đà La đồng cung, gặp sát thì cô độc quý, có quyền mà không có tài.',
    ...
    worstPalace: 'Tật Ách Cung, Phu Thê Cung',
  ...
  '太阳': {
    ...
    worstPalace: 'Phu Thê Cung (nữ mệnh), Tật Ách Cung',
  ...
  '武曲': {
    niHaixia: 'Thầy Ni xem Vũ Khúc là tài bạch chủ tinh, cương ngạnh bất khuất, sợ nhất cô độc khắc. Người Vũ Khúc tọa mệnh ý chí kiên định, thích hợp tài chính, quản lý tài sản, nhưng tình cảm quá thẳng, dễ làm tổn thương người khác. Vũ Khúc hóa Kỵ phải cẩn thận tai nạn đổ máu. Vũ Khúc ở Thìn Tuất Sửu Mùi được vượng địa, cùng Thất Sát đồng cung có thể thành tướng tài cục, là cục diện tài vận cực kỳ tốt.',
    classical: 'Cổ quyết: "Vũ Khúc thuộc Kim, cương cường chi tính, nhất sinh đa hình khắc; thủ mệnh ư vượng địa, xuất tướng nhập tướng." Nam Bắc Sơn Nhân chú: "Vũ Khúc thủ mệnh, tam phương tứ chính câu cát, tài quan song mỹ, võ chức gia phụ ủy xương khúc, diệc chủ đại quý; dữ Thất Sát đồng cung, vi tướng tài cục, chủ đại phú."',
  ...
  '天同': {
    ...
    bestPalace: 'Mệnh Cung, Phúc Đức Cung',
  ...
  '廉贞': {
    niHaixia: 'Thầy Ni cho rằng Liêm Trinh là thứ tình hoa, tài năng xuất chúng nhưng tình cảm phức tạp. Liêm Trinh hóa Kỵ phiền phức cực kỳ, đại diện kiện tụng, lao tù, bất ngờ. Liêm Trinh cùng Thiên Tướng đồng cung thì hóa hung thành cát, trở thành cục hành chính ấn thụ chi cục. Liêm Trinh ngũ hành thuộc Hỏa, tính cách cương liệt, một đời nhiều thăng trầm, tài năng xuất chúng, nếu có thể giữ chính bất tà, có thể thành đại khí.',
    classical: 'Cổ quyết: "Liêm Trinh vi thứ tình hoa, tài năng hoành túc, tình cảm đa ba thuyết; Liêm Tướng đồng cung, hóa hung vi kỳ, thành hành chính ấn thụ cục, khả chưởng quyền bính." Nam Bắc Sơn Nhân chú: "Liêm Trinh thủ mệnh, kiến cát tinh tắc tài năng xuất chúng, hóa Kỵ tắc quan tụng, chủ huyết quang chi tai, tu phòng."',
    bestPalace: 'Quan Lộc Cung (phối Thiên Tướng), Mệnh Cung (hóa Lộc)',
    worstPalace: 'Mệnh Cung (hóa Kỵ), Phu Thê Cung',
    career: 'Nghệ thuật, giải trí, pháp luật, công vụ (phối Thiên Tướng), tài năng xuất chúng, nên giữ chính nghiệp mới bền lâu',
  ...
  '贪狼': {
    niHaixia: 'Thầy Ni nói Tham Lang là sao đa tài đa nghệ nhất, đào hoa nặng nhất. Tham Lang hóa Lộc nhập mệnh thì mị lực bốn phía, người gặp người yêu. Tham Lang thuộc vãn phát chi tinh, trung niên sau mới thực sự phát đạt. Tham Lang ở Dần Thân vị nhập miếu tốt nhất, đào hoa vượng, tài nghệ siêu quần; hóa Lộc sau tài vận đại phát, nhưng nếu gặp Không Kiếp thì một đời nhiều sóng gió, khó tụ tài.',
    classical: 'Cổ quyết: "Tham Lang phát phúc hanh thông, đa tài đa nghệ, tình hoa tối trọng; nhiên nan quá tam thập tuế, vãn phát giả chúng." Nam Bắc Sơn Nhân chú: "Tham Lang thủ mệnh, phùng cát tắc phúc lộc đa thọ, phát phúc hanh thông; nhưng cửu hậu bất đắc thiện chung, cố nghi tu thân dưỡng đức, phương khả thiện chung."',
    bestPalace: 'Mệnh Cung (hóa Lộc), Phúc Đức Cung, Thiên Di Cung',
  ...
  '巨门': {
    niHaixia: 'Thầy Ni cho rằng Cự Môn là sao khẩu chi thị phi, nhưng hóa Lộc hóa Quyền chuyển thành cát, trở thành cục diện kiếm tiền bằng khẩu tài. Cự Môn tọa mệnh đa nghi, thiện biện, thích hợp luật sư, giáo viên, bán hàng. Cự Môn sợ nhất hóa Kỵ, chủ khẩu chi thị phi không ngừng, thậm chí dẫn đến kiện tụng. Cự Môn ở Tý Ngọ vị tương đối tốt, khẩu tài tốt, chủ lấy ngôn ngữ lập thân.',
    classical: 'Cổ quyết: "Cự Môn vi ám diệu chi tinh, chủ khẩu chi thị phi; hóa Lộc Quyền tắc chuyển vi dĩ khẩu tài mưu sinh, chủ phú quý." Nam Bắc Sơn Nhân chú: "Cự Môn thủ mệnh, phùng hóa Lộc Quyền, dĩ khẩu chi vi nghiệp giả đại cát; hóa Kỵ tắc khẩu chi liên lụy, quan tụng, tu cẩn ngữ ngôn."',
    bestPalace: 'Quan Lộc Cung (hóa Lộc Quyền), Mệnh Cung (Tý Ngọ)',
    worstPalace: 'Phu Thê Cung, Tật Ách Cung (hóa Kỵ)',
  ...
  '天相': {
    niHaixia: 'Thầy Ni nói Thiên Tướng là ấn thụ tinh, phụ trách hành chính sự vụ. Người Thiên Tướng tọa mệnh trung quy tắc, thích hợp công vụ hành chính. Thiên Tướng cần nhất có sao mạnh tương phối mới phát huy được, đơn độc tọa mệnh khá bình thường. Thiên Tướng thích nhất Liêm Trinh tương tùy, tạo thành Liêm Tướng cục, có thể chủ đại quyền hành chính; sợ nhất Phá Quân đồng cung, tạo thành hình kỵ giáp ấn cục, chủ hung hiểm.',
    classical: 'Cổ quyết: "Thiên Tướng vi ấn thụ chi tinh, chủ hành chính sự vụ; Liêm Tướng đồng cung, hóa hung vi cát, chưởng hành chính đại quyền." Nam Bắc Sơn Nhân chú: "Thiên Tướng thủ mệnh, trung quy tắc, thích hợp công vụ; đắc Liêm Trinh tương phối, khả thành quốc gia tòng lãnh; Phá Quân đồng thủ, tắc hình khắc nan tránh."',
    bestPalace: 'Quan Lộc Cung (phối Liêm Trinh), Mệnh Cung (phối Liêm Trinh)',
  ...
  '天梁': {
    ...
    bestPalace: 'Mệnh Cung, Phụ Mẫu Cung, Phúc Đức Cung',
  ...
  '七杀': {
    ...
    worstPalace: 'Phu Thê Cung, Phụ Mẫu Cung',
    ...
    wealth: 'Tài vận dao động lớn, có cơ hội giàu có, cũng có thăng trầm lớn; Vũ Khúc đồng cung có thể thành tướng tài cục đại quý',
              ...
              <div className="text-xs leading-relaxed" style={{ color: 'var(--color-text-body)' }}>
                {star.type === 'lucky' && (
                  <>
                    ...
                    {star.name === '右弼' && 'Hữu Bật nhập cung, chủ quý nhân giúp đỡ, nhiều quý nhân nữ giới, việc trong cung có người hỗ trợ. Cổ quyết: "Hữu Bật vi âm trợ chi tinh, đa nữ quý nhân, hóa hiểm vi nha."'}
                    ...
                    {star.name === '天钺' && 'Thiên Việt nhập cung, chủ quý nhân sinh ban đêm, quý nhân nữ giới nhiều, tăng thêm khí lành cát giới. Cổ quyết: "Thiên Việt vi ngọc đường quý nhân, chủ âm trợ, nữ quý nhân đa."'}
                ...
                {star.type === 'sha' && (
                  <>
                    ...
                    {star.name === '火星' && 'Hỏa Tinh nhập cung, chủ việc trong cung nóng nảy xung động, cảm xúc dao động, nhưng nếu gặp Tham Lang thì ngược lại thành cát. Cổ quyết: "Hỏa Tinh chủ cấp rộ, nhiên ngộ Tham Lang đồng cung, phản vi hỏa đam cục, chủ bạo phát."'}
