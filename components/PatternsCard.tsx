  ...
  return (
    ...
    >
      <div className="text-[10px] tracking-widest mb-3 flex items-center gap-2" style={{ color: 'var(--color-text-muted)' }}>
        ...
        Nhận Diện Cươc Trạch (điều kiện cổ thư nghiêm ngặt)
        <span className="text-[9px] ml-auto" style={{ color: 'var(--color-text-muted)', opacity: 0.75 }}>{patterns.length} cươc</span>
      </div>
