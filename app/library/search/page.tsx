      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="text-center mb-10">
          ...
          <div style={{ fontSize: '12px', color: 'var(--tx-3)', marginTop: '8px' }}>
            Tìm thấy tổng cộng <strong style={{ color: 'var(--ac)' }}>{hits.length}</strong> kết quả khớp nguyên tác cổ thư
          </div>
        </div>
            ...
            {q ? (
              <>
                ...
                <div style={{ fontSize: '11px', color: 'var(--tx-3)', lineHeight: 1.7 }}>
                  ...
                  <span style={{ color: 'var(--ac)' }}>Thập sát triều đấu / Song lộc triều viên / Hóa kỵ / Tử Vi / Mệnh cung / Cơ nguyệt đồng lương</span>
                </div>
              </>
            ) : (
