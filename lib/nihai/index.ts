...
export const NI_HAIXIA_BIO = {
  ...
  /** 師承關係 */
  teachers: [
    { name: '周左宇', background: '北京四代家傳名醫，1949年後移居台灣', subject: '針灸', period: '1977-1981' },
  ...
  /** 人生大事記 */
  timeline: [
    { year: '1954', event: '出生於台北市，祖籍浙江瑞安' },
    { year: '1970s', event: '高中時以《醫宗金鑒》癒合二姐月經痛，立志習醫' },
    ...
    { year: '1988', event: '在台北金山南路開辦"天文地理班"，傳授紫微斗數和住宅風水' },
    { year: '1991', event: '成為美國佛羅里達州注冊針灸師' },
    ...
    { year: '2004', event: '在台北開設《人紀》中醫教學班' },
    { year: '2005', event: '《人紀》系列教學DVD出版' },
    { year: '2007', event: '開始撰寫《地紀》' },
    { year: '2010', event: '成立台北漢唐經方中醫診所；受邀第三屆扶陽論壇整天演講' },
    { year: '2011', event: '成立深圳漢唐經方中醫館' },
    { year: '2012', event: '1月31日因心肺衰竭在台北辭世，享年59歲' },
  ],
  /** 著作體系 */
  publications: {
    originalBooks8: ['黃帝內經素問', '黃帝內經', '神農本草經', '針灸', '傷寒論', '金匱', '人間道', '天機道·地脈道'],
    totalBooks: '26-44冊（含注解版教材、醫案全集、穴位精解等）',
